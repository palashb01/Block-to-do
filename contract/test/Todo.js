...
describe("Todo Contract Testing \n--------------------------------------------", () => {
  describe("Testing individually", () => {
    ...
    it("creates a task as the owner", async () => {
      const task = await contract.createTask(testTask);
    ...
    it("creates the task as a second account", async () => {
      const task = await contract.connect(test1).createTask(testTaskSecondary);
  ...
  describe("Testing compound", () => {
    ...
    before(async () => {
      ...
      const task1 = await contract.createTask(testTask1);
      const task2 = await contract.createTask(testTask2);
    });
    ...
    it("tries to retrieve all tasks of a user", async () => {
        ...
        await contract.connect(test1).createTask(testTask1);
